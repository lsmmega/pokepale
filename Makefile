...
.SUFFIXES:
.PHONY: all pale crystal11 crystal_au crystal_debug crystal11_debug clean tidy compare tools
.SECONDEXPANSION:
.PRECIOUS:
.SECONDARY:
...
$(foreach obj, $(pokepale_obj), $(eval $(call DEP,$(obj),$(obj:.o=.asm))))
...
pokepale_opt            = -Cjv -t PM_PALE -i BYTE -n 0 -k 01 -l 0x33 -m MBC3+TIMER+RAM+BATTERY -r 3 -p 0
