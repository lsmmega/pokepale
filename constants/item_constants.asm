...
; - ItemEffects (see engine/items/item_effects.asm)
	...
	const ITEM_57      ; 57
	const AMULET_COIN  ; 58
	const YLW_APRICORN ; 59
	const GRN_APRICORN ; 5a
	const CLEANSE_TAG  ; 5b
	const MYSTIC_WATER ; 5c
	const TWISTEDSPOON ; 5d
	const WHT_APRICORN ; 5e
	const BLACKBELT_I  ; 5f
	const BLK_APRICORN ; 60
	const ITEM_61      ; 61
	...
	const ITEM_B0      ; b0
	const BRICK_PIECE  ; b1
	const SURF_MAIL    ; b2
	const LITEBLUEMAIL ; b3
	const PORTRAITMAIL ; b4
	const LOVELY_MAIL  ; b5
	const EON_MAIL     ; b6
	const MORPH_MAIL   ; b7
	const BLUESKY_MAIL ; b8
	const MUSIC_MAIL   ; b9
	const MIRAGE_MAIL  ; ba
	const ITEM_BB      ; bb
