...
; BattleAnimObjects indexes (see data/battle_anims/objects.asm)
	...
	const BATTLE_ANIM_OBJ_SONICBOOM_JP        ; 41
	const BATTLE_ANIM_OBJ_WARP                ; 42
	const BATTLE_ANIM_OBJ_ABSORB              ; 43
	const BATTLE_ANIM_OBJ_EGG                 ; 44
	const BATTLE_ANIM_OBJ_FOCUS               ; 45
	const BATTLE_ANIM_OBJ_BIND1               ; 46
	const BATTLE_ANIM_OBJ_BIND2               ; 47
	const BATTLE_ANIM_OBJ_LEECH_SEED          ; 48
	const BATTLE_ANIM_OBJ_SOUND               ; 49
	const BATTLE_ANIM_OBJ_WAVE                ; 4a
	const BATTLE_ANIM_OBJ_CONFUSE_RAY         ; 4b
	const BATTLE_ANIM_OBJ_LEER                ; 4c
	const BATTLE_ANIM_OBJ_LEER_TIP            ; 4d
	const BATTLE_ANIM_OBJ_SCREEN              ; 4e
	const BATTLE_ANIM_OBJ_HARDEN              ; 4f
	...
	const BATTLE_ANIM_OBJ_SONICBOOM_JP_UNUSED ; 62
	const BATTLE_ANIM_OBJ_MIMIC               ; 63
	const BATTLE_ANIM_OBJ_ATTRACT             ; 64
	const BATTLE_ANIM_OBJ_BONEMERANG          ; 65
	const BATTLE_ANIM_OBJ_BONE_CLUB           ; 66
	const BATTLE_ANIM_OBJ_BONE_RUSH           ; 67
	const BATTLE_ANIM_OBJ_SWIFT               ; 68
	const BATTLE_ANIM_OBJ_KINESIS             ; 69
	const BATTLE_ANIM_OBJ_FLASH               ; 6a
	const BATTLE_ANIM_OBJ_SHINY               ; 6b
	const BATTLE_ANIM_OBJ_SKY_ATTACK          ; 6c
	const BATTLE_ANIM_OBJ_LICK                ; 6d
	const BATTLE_ANIM_OBJ_WITHDRAW            ; 6e
	const BATTLE_ANIM_OBJ_DRAIN               ; 6f
	const BATTLE_ANIM_OBJ_GROWTH              ; 70
	const BATTLE_ANIM_OBJ_CONVERSION2         ; 71
	const BATTLE_ANIM_OBJ_SMOKE               ; 72
	const BATTLE_ANIM_OBJ_SMOKESCREEN         ; 73
	const BATTLE_ANIM_OBJ_SWORDS_DANCE        ; 74
	const BATTLE_ANIM_OBJ_SPEED_LINE          ; 75
	const BATTLE_ANIM_OBJ_SHARPEN             ; 76
	const BATTLE_ANIM_OBJ_DEFENSE_CURL        ; 77
	const BATTLE_ANIM_OBJ_METRONOME_HAND      ; 78
	const BATTLE_ANIM_OBJ_METRONOME_SPARKLE   ; 79
	const BATTLE_ANIM_OBJ_DISABLE             ; 7a
	const BATTLE_ANIM_OBJ_AGILITY             ; 7b
	const BATTLE_ANIM_OBJ_HEART               ; 7c
	const BATTLE_ANIM_OBJ_FLAME_WHEEL         ; 7d
	const BATTLE_ANIM_OBJ_SACRED_FIRE         ; 7e
	const BATTLE_ANIM_OBJ_COTTON_SPORE        ; 7f
	const BATTLE_ANIM_OBJ_MILK_DRINK          ; 80
	const BATTLE_ANIM_OBJ_ANGER               ; 81
	const BATTLE_ANIM_OBJ_HEAL_BELL           ; 82
	const BATTLE_ANIM_OBJ_HEAL_BELL_NOTE      ; 83
	const BATTLE_ANIM_OBJ_BATON_PASS          ; 84
	const BATTLE_ANIM_OBJ_LOCK_ON             ; 85
	const BATTLE_ANIM_OBJ_MIND_READER         ; 86
	const BATTLE_ANIM_OBJ_SAFEGUARD           ; 87
	const BATTLE_ANIM_OBJ_PROTECT             ; 88
	const BATTLE_ANIM_OBJ_THIEF               ; 89
	const BATTLE_ANIM_OBJ_OCTAZOOKA           ; 8a
	const BATTLE_ANIM_OBJ_PRESENT             ; 8b
	const BATTLE_ANIM_OBJ_SPIKES              ; 8c
	const BATTLE_ANIM_OBJ_POWDER_SNOW         ; 8d
	const BATTLE_ANIM_OBJ_DRAGONBREATH        ; 8e
	const BATTLE_ANIM_OBJ_CONVERSION          ; 8f
	const BATTLE_ANIM_OBJ_SPIDER_WEB          ; 90
	const BATTLE_ANIM_OBJ_CAKE_UNUSED         ; 91
	const BATTLE_ANIM_OBJ_NIGHTMARE           ; 92
	const BATTLE_ANIM_OBJ_IN_NIGHTMARE        ; 93
	const BATTLE_ANIM_OBJ_LOVELY_KISS         ; 94
	const BATTLE_ANIM_OBJ_SWEET_KISS          ; 95
	const BATTLE_ANIM_OBJ_SKETCH              ; 96
	const BATTLE_ANIM_OBJ_ENCORE_HAND         ; 97
	const BATTLE_ANIM_OBJ_ENCORE_STAR         ; 98
	const BATTLE_ANIM_OBJ_DESTINY_BOND        ; 99
	const BATTLE_ANIM_OBJ_MORNING_SUN         ; 9a
	const BATTLE_ANIM_OBJ_GLIMMER             ; 9b
	const BATTLE_ANIM_OBJ_MOONLIGHT           ; 9c
	const BATTLE_ANIM_OBJ_HIDDEN_POWER        ; 9d
	const BATTLE_ANIM_OBJ_CROSS_CHOP1         ; 9e
	const BATTLE_ANIM_OBJ_CROSS_CHOP2         ; 9f
	const BATTLE_ANIM_OBJ_SANDSTORM           ; a0
	const BATTLE_ANIM_OBJ_ZAP_CANNON          ; a1
	const BATTLE_ANIM_OBJ_SPITE               ; a2
	const BATTLE_ANIM_OBJ_CURSE               ; a3
	const BATTLE_ANIM_OBJ_PERISH_SONG         ; a4
	const BATTLE_ANIM_OBJ_FORESIGHT           ; a5
	const BATTLE_ANIM_OBJ_RAPID_SPIN          ; a6
	const BATTLE_ANIM_OBJ_SWAGGER             ; a7
	const BATTLE_ANIM_OBJ_BELLY_DRUM_HAND     ; a8
	const BATTLE_ANIM_OBJ_BELLY_DRUM_NOTE     ; a9
	const BATTLE_ANIM_OBJ_MEAN_LOOK           ; aa
	const BATTLE_ANIM_OBJ_BETA_PURSUIT        ; ab
...
; DoBattleAnimFrame arguments (see engine/battle_anims/functions.asm)
	...
	const BATTLE_ANIM_FUNC_KICK                      ; 1a
	const BATTLE_ANIM_FUNC_ABSORB                    ; 1b
	const BATTLE_ANIM_FUNC_EGG                       ; 1c
	const BATTLE_ANIM_FUNC_MOVE_UP                   ; 1d
	const BATTLE_ANIM_FUNC_WRAP                      ; 1e
	const BATTLE_ANIM_FUNC_LEECH_SEED                ; 1f
	const BATTLE_ANIM_FUNC_SOUND                     ; 20
	const BATTLE_ANIM_FUNC_CONFUSE_RAY               ; 21
	const BATTLE_ANIM_FUNC_DIZZY                     ; 22
	const BATTLE_ANIM_FUNC_AMNESIA                   ; 23
	const BATTLE_ANIM_FUNC_FLOAT_UP                  ; 24
	const BATTLE_ANIM_FUNC_DIG                       ; 25
	const BATTLE_ANIM_FUNC_STRING                    ; 26
	const BATTLE_ANIM_FUNC_PARALYZED                 ; 27
	const BATTLE_ANIM_FUNC_SPIRAL_DESCENT            ; 28
	const BATTLE_ANIM_FUNC_POISON_GAS                ; 29
	const BATTLE_ANIM_FUNC_HORN                      ; 2a
	const BATTLE_ANIM_FUNC_NEEDLE                    ; 2b
	const BATTLE_ANIM_FUNC_PETAL_DANCE               ; 2c
	const BATTLE_ANIM_FUNC_THIEF_PAYDAY              ; 2d
	const BATTLE_ANIM_FUNC_ABSORB_CIRCLE             ; 2e
	const BATTLE_ANIM_FUNC_BONEMERANG                ; 2f
	const BATTLE_ANIM_FUNC_SHINY                     ; 30
	const BATTLE_ANIM_FUNC_SKY_ATTACK                ; 31
	const BATTLE_ANIM_FUNC_GROWTH_SWORDS_DANCE       ; 32
	const BATTLE_ANIM_FUNC_SMOKE_FLAME_WHEEL         ; 33
	const BATTLE_ANIM_FUNC_PRESENT_SMOKESCREEN       ; 34
	const BATTLE_ANIM_FUNC_STRENGTH_SEISMIC_TOSS     ; 35
	const BATTLE_ANIM_FUNC_SPEED_LINE                ; 36
	const BATTLE_ANIM_FUNC_SLUDGE                    ; 37
	const BATTLE_ANIM_FUNC_METRONOME_HAND            ; 38
	const BATTLE_ANIM_FUNC_METRONOME_SPARKLE_SKETCH  ; 39
	const BATTLE_ANIM_FUNC_AGILITY                   ; 3a
	const BATTLE_ANIM_FUNC_SACRED_FIRE               ; 3b
	const BATTLE_ANIM_FUNC_SAFEGUARD_PROTECT         ; 3c
	const BATTLE_ANIM_FUNC_LOCK_ON_MIND_READER       ; 3d
	const BATTLE_ANIM_FUNC_SPIKES                    ; 3e
	const BATTLE_ANIM_FUNC_HEAL_BELL_NOTES           ; 3f
	const BATTLE_ANIM_FUNC_BATON_PASS                ; 40
	const BATTLE_ANIM_FUNC_CONVERSION                ; 41
	const BATTLE_ANIM_FUNC_ENCORE_BELLY_DRUM         ; 42
	const BATTLE_ANIM_FUNC_SWAGGER_MORNING_SUN       ; 43
	const BATTLE_ANIM_FUNC_HIDDEN_POWER              ; 44
	const BATTLE_ANIM_FUNC_CURSE                     ; 45
	const BATTLE_ANIM_FUNC_PERISH_SONG               ; 46
	const BATTLE_ANIM_FUNC_RAPID_SPIN                ; 47
	const BATTLE_ANIM_FUNC_BETA_PURSUIT              ; 48
...
; BattleAnimFrameData indexes (see data/battle_anims/framesets.asm)
	...
	const BATTLE_ANIM_FRAMESET_SONICBOOM_JP          ; 48
	...
	const BATTLE_ANIM_FRAMESET_MEGAPHONE_UNUSED      ; 96
	const BATTLE_ANIM_FRAMESET_ITEM_BAG              ; 97
	const BATTLE_ANIM_FRAMESET_SPIDER_WEB            ; 98
	const BATTLE_ANIM_FRAMESET_UNUSED_CAKE           ; 99
	const BATTLE_ANIM_FRAMESET_IMP                   ; 9a
	const BATTLE_ANIM_FRAMESET_IMP_FLIPPED           ; 9b
	const BATTLE_ANIM_FRAMESET_CHERUB                ; 9c
	const BATTLE_ANIM_FRAMESET_PENCIL                ; 9d
	const BATTLE_ANIM_FRAMESET_ENCORE_HAND           ; 9e
	const BATTLE_ANIM_FRAMESET_ENCORE_HAND_FLIPPED   ; 9f
	const BATTLE_ANIM_FRAMESET_DESTINY_BOND          ; a0
	const BATTLE_ANIM_FRAMESET_MORNING_SUN           ; a1
	const BATTLE_ANIM_FRAMESET_GLIMMER               ; a2
	const BATTLE_ANIM_FRAMESET_MOONLIGHT             ; a3
	const BATTLE_ANIM_FRAMESET_CROSS_CHOP_1          ; a4
	const BATTLE_ANIM_FRAMESET_CROSS_CHOP_2          ; a5
	const BATTLE_ANIM_FRAMESET_ZAP_CANNON            ; a6
	const BATTLE_ANIM_FRAMESET_CURSE_NAIL            ; a7
	const BATTLE_ANIM_FRAMESET_FORESIGHT_SHINE       ; a8
	const BATTLE_ANIM_FRAMESET_RAPID_SPIN            ; a9
	const BATTLE_ANIM_FRAMESET_SWAGGER               ; aa
	const BATTLE_ANIM_FRAMESET_MEAN_LOOK             ; ab
	const BATTLE_ANIM_FRAMESET_UPSIDE_DOWN_PUNCH     ; ac
	const BATTLE_ANIM_FRAMESET_GROWING_SPARKLE       ; ad
	const BATTLE_ANIM_FRAMESET_RAIN                  ; ae
	const BATTLE_ANIM_FRAMESET_PSYCH_UP              ; af
	const BATTLE_ANIM_FRAMESET_SPIRAL_UNUSED         ; b0
	const BATTLE_ANIM_FRAMESET_AEROBLAST             ; b1
	const BATTLE_ANIM_FRAMESET_SANDSTORM             ; b2
	...
	const BATTLE_ANIM_FRAMESET_HAIL                  ; b7
