...
; Johto Gym Leader TM gifts
	...
	const EVENT_GOT_TM52_FLY
	const EVENT_GOT_TM53_SURF
	const EVENT_GOT_TM54_STRENGTH
	const EVENT_GOT_TM55_FLASH
	const EVENT_GOT_TM56_WHIRLPOOL
	const_skip ; unused
; Rods
...
; Johto story events
	...
	const EVENT_GOT_FENNEKIN_FROM_ELM
	const EVENT_GOT_QUAXLY_FROM_ELM
	const EVENT_GOT_TURTWIG_FROM_ELM
...
; Johto itemballs
	const EVENT_FENNEKIN_POKEBALL_IN_ELMS_LAB
	const EVENT_QUAXLY_POKEBALL_IN_ELMS_LAB
	const EVENT_TURTWIG_POKEBALL_IN_ELMS_LAB
	...
	const EVENT_GOT_TM57_WATERFALL
