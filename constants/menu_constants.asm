...
; used by PokemonActionSubmenu (see engine/pokemon/mon_menu.asm)
	...
	const MONMENUITEM_FLASH      ; 2
	const MONMENUITEM_DIG        ; 3
	const MONMENUITEM_TELEPORT   ; 4
	const MONMENUITEM_SOFTBOILED ; 5
	const MONMENUITEM_MILKDRINK  ; 6
	const MONMENUITEM_SWEETSCENT ; 7
	; options
