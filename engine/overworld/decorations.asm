...
.ornaments:
	...
	db DECO_POLIWAG_DOLL ; 22
	db DECO_DIGLETT_DOLL ; 23
	db DECO_STARYU_DOLL ; 24
	db DECO_MAGIKARP_DOLL ; 25
	db DECO_ODDISH_DOLL ; 26
	db DECO_GENGAR_DOLL ; 27
	db DECO_SHELLDER_DOLL ; 28
	db DECO_GRIMER_DOLL ; 29
	db DECO_VOLTORB_DOLL ; 2a
	db DECO_WEEDLE_DOLL ; 2b
	db DECO_UNOWN_DOLL ; 2c
	db DECO_GEODUDE_DOLL ; 2d
	db DECO_MACHOP_DOLL ; 2e
	db DECO_TENTACOOL_DOLL ; 2f
	db DECO_GOLD_TROPHY_DOLL ; 30
	db DECO_SILVER_TROPHY_DOLL ; 31
	db -1
