...
ChampionGroup:
	...
	db 46, Delphox,  FLAMETHROWER, WING_ATTACK, SLASH, HYPER_BEAM
...
CooltrainerMGroup:
	...
	db 27, Braixen, EMBER, SMOKESCREEN, RAGE, SCARY_FACE
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 32, Quaquaval,  BITE, CURSE, SURF, RAIN_DANCE
	db -1 ; end
	...
	db 32, Torterra,   BODY_SLAM, SLEEP_POWDER, RAZOR_LEAF, SWEET_SCENT
	db -1 ; end
	...
	db 25, Turtwig, CONFUSION, SLEEP_POWDER, WHIRLWIND, GUST
...
PicnickerGroup:
	...
	db 38, Torterra,   SOLARBEAM, RAZOR_LEAF, HEADBUTT, MUD_SLAP
	db -1 ; end
...
RedGroup:
	...
	db 77, Quaquaval,  RAIN_DANCE, SURF, BLIZZARD, WHIRLPOOL
	db -1 ; end
