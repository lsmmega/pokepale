...
FalknerGroup:
	...
	db 11, HOOTHOOT,   TACKLE, MUD_SLAP, PECK, NO_MOVE
	db -1 ; end
...
Rival1Group:
	...
	db 22, GROTLE,     LEECH_SEED, POISONPOWDER, SLEEP_POWDER, RAZOR_LEAF
	db -1 ; end
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 20, ZUBAT,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 22, BRAIXEN,    GROWL, EMBER, SMOKESCREEN, RAGE
	db -1 ; end
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 20, ZUBAT,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 22, QUAXWELL,   BUBBLE, WITHDRAW, WATER_GUN, BITE
	db -1 ; end
	...
	db 32, TORTERRA,   POISONPOWDER, SLEEP_POWDER, RAZOR_LEAF, SWEET_SCENT
	db -1 ; end
	...
	db 30, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, BRAIXEN,    EMBER, SMOKESCREEN, RAGE, SCARY_FACE
	db -1 ; end
	...
	db 30, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, QUAXWELL,   WATER_GUN, BITE, RAPID_SPIN, PROTECT
	db -1 ; end
	...
	db 38, TORTERRA,   POISONPOWDER, SLEEP_POWDER, RAZOR_LEAF, SWEET_SCENT
	db -1 ; end
	...
	db 35, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, DELPHOX,    SMOKESCREEN, RAGE, SCARY_FACE, FLAMETHROWER
	db -1 ; end
	...
	db 35, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, QUAQUAVAL,  WATER_GUN, BITE, RAPID_SPIN, PROTECT
	db -1 ; end
...
ChampionGroup:
	...
	db 46, TYPHLOSION, QUICK_ATTACK, FLAME_WHEEL, SWIFT, HYPER_BEAM
...
BirdKeeperGroup:
	...
	db 38, NOCTOWL,    TOXIC, HYPNOSIS, REFLECT, FLY
	db 38, NOCTOWL,    SWIFT, DETECT, STEEL_WING, FLY
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 26, CYNDAQUIL,  LEER, SMOKESCREEN, EMBER, QUICK_ATTACK
	db 26, TOTODILE,   RAGE, WATER_GUN, BITE, CURSE
	db 26, CHIKORITA,  RAZOR_LEAF, REFLECT, POISONPOWDER, SYNTHESIS
	db -1 ; end
	...
	db 25, NOCTOWL,    FORESIGHT, PECK, HYPNOSIS, REFLECT
...
CooltrainerFGroup:
	...
	db 32, FERALIGATR, BITE, CURSE, SURF, RAIN_DANCE
	db -1 ; end
	...
	db 32, CHIKORITA,  RAZOR_LEAF, REFLECT, POISONPOWDER, SYNTHESIS
	db 32, BAYLEEF,    RAZOR_LEAF, REFLECT, POISONPOWDER, SYNTHESIS
	db 32, MEGANIUM,   RAZOR_LEAF, REFLECT, POISONPOWDER, BODY_SLAM
	db -1 ; end
...
Rival2Group:
	...
	db 45, TORTERRA,   SLEEP_POWDER, RAZOR_LEAF, SWEET_SCENT, GROWTH
	db -1 ; end
	...
	db 43, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 45, FENNEKIN,   RAGE, SCARY_FACE, FLAMETHROWER, SLASH
	db -1 ; end
	...
	db 43, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 45, QUAQUAVAL,  BITE, RAPID_SPIN, PROTECT, RAIN_DANCE
	db -1 ; end
	...
	db 50, TORTERRA,   SLEEP_POWDER, RAZOR_LEAF, SWEET_SCENT, GROWTH
	db -1 ; end
	...
	db 46, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 46, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 50, FENNEKIN,   RAGE, SCARY_FACE, FLAMETHROWER, SLASH
	db -1 ; end
	...
	db 46, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 46, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 50, QUAQUAVAL,  BITE, RAPID_SPIN, PROTECT, RAIN_DANCE
	db -1 ; end
...
RedGroup:
	...
	db 77, MEGANIUM,   SUNNY_DAY, GIGA_DRAIN, SYNTHESIS, SOLARBEAM
	db 77, TYPHLOSION, QUICK_ATTACK, FLAME_WHEEL, SWIFT, FLAMETHROWER
	db 77, FERALIGATR, RAIN_DANCE, SURF, BLIZZARD, WHIRLPOOL
	db -1 ; end

BlueGroup:
	; BLUE (1)
	db "BLUE@", TRAINERTYPE_MOVES
	db 56, NOCTOWL,    HYPNOSIS, REFLECT, TAKE_DOWN, CONFUSION
