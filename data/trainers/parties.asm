...
Rival1Group:
	...
	db 22, IVYSAUR,    GROWL, PECK, RAZOR_LEAF, SYNTHESIS
	db -1 ; end
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 20, ZUBAT,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 22, TORRACAT,   EMBER, MACH_PUNCH, FURY_SWIPES, FLAME_WHEEL
	db -1 ; end
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 20, ZUBAT,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 22, MARSHTOMP,  WATER_GUN, QUICK_ATTACK, LICK, SMOKESCREEN
	db -1 ; end
	...
	db 32, IVYSAUR,    GROWL, PECK, RAZOR_LEAF, SYNTHESIS
	db -1 ; end
	...
	db 30, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, TORRACAT,   EMBER, MACH_PUNCH, FURY_SWIPES, FLAME_WHEEL
	db -1 ; end
	...
	db 30, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, MARSHTOMP,  WATER_GUN, QUICK_ATTACK, LICK, SMOKESCREEN
	db -1 ; end
	...
	db 38, VENUSAUR,  GROWL, PECK, RAZOR_LEAF, SYNTHESIS
	db -1 ; end
	...
	db 35, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, INCINEROAR,  EMBER, MACH_PUNCH, FURY_SWIPES, FLAME_WHEEL
	db -1 ; end
	...
	db 35, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, SWAMPERT,   QUICK_ATTACK, LICK, SMOKESCREEN, SPIKES
	db -1 ; end
...
Rival2Group:
	...
	db 45, VENUSAUR,  GROWL, PECK, RAZOR_LEAF, SYNTHESIS
	db -1 ; end
	...
	db 43, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 45, INCINEROAR,  MACH_PUNCH, FURY_SWIPES, FLAME_WHEEL, FIRE_SPIN
	db -1 ; end
	...
	db 43, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 45, SWAMPERT,   LICK, SMOKESCREEN, SPIKES, SUBSTITUTE
	db -1 ; end
	...
	db 50, VENUSAUR,  GROWL, PECK, RAZOR_LEAF, SYNTHESIS
	db -1 ; end
	...
	db 46, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 46, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 50, INCINEROAR,  MACH_PUNCH, FURY_SWIPES, FLAME_WHEEL, FIRE_SPIN
	db -1 ; end
	...
	db 46, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 46, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 50, SWAMPERT,   LICK, SMOKESCREEN, SPIKES, SUBSTITUTE
	db -1 ; end
