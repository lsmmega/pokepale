...
; BATTLE_ANIM_OBJ_LEAF_BLADE
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLE_ANIM_FRAMESET_SWORD_DOWN_LEFT, BATTLE_ANIM_FUNC_NULL, PAL_BATTLE_OB_GREEN, BATTLE_ANIM_GFX_WHIP
