...
.hi_bi_pi: db CLEFFA, WEEDLE, CLEFABLE, PIDGEOT, PIDGEOTTO, CLEFAIRY, STARYU, CYNDAQUIL, SUNKERN, TEDDIURSA, VOLTORB, -1
.fu_bu_pu: db MOLTRES, FLAREON, ALAKAZAM, MAGMAR, FORRETRESS, WIGGLYTUFF, AERODACTYL, MAGBY, IGGLYBUFF, UMBREON, ARTICUNO, JIGGLYPUFF, SNUBBULL, -1
...
.ra:       db RAIKOU, CHANSEY, RATICATE, LAPRAS, VILEPLUME, LANTURN, -1
.ri:       db URSARING, -1
.ru:       db JYNX, LUGIA, -1
