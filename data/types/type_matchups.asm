TypeMatchups:
	...
	db WATER,        GRASS,        NO_EFFECT
	db WATER,        ICE,          NO_EFFECT
	...
	db GRASS,        DARK,         SUPER_EFFECTIVE
	db GRASS,        FAIRY,        SUPER_EFFECTIVE
	db ICE,          FIRE,         NOT_VERY_EFFECTIVE
	db ICE,          WATER,        NO_EFFECT
