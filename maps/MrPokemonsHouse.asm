...
MrPokemonsHouse_OakScript:
	...
	iftrue .RivalTakesLitten
	setevent EVENT_MUDKIP_POKEBALL_IN_ELMS_LAB
	end

.RivalTakesBulbasaur:
	setevent EVENT_BULBASAUR_POKEBALL_IN_ELMS_LAB
	end

.RivalTakesLitten:
	setevent EVENT_LITTEN_POKEBALL_IN_ELMS_LAB
	end
