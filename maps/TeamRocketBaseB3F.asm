...
TeamRocketBaseB3F_MapEvents:
	...
	object_event  5, 14, SPRITE_ROCKET, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 0, RaticateTailGrunt, EVENT_TEAM_ROCKET_BASE_POPULATION
	...
	object_event 11, 15, SPRITE_SCIENTIST, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 0, TrainerScientistMitch, EVENT_TEAM_ROCKET_BASE_POPULATION
