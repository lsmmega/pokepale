...
If you have different projects that require different versions of `rgbds`, it might not be convenient to install rgbds 0.9.3 globally. Instead, you can put its files in a directory within pokepale, such as `pokepale/rgbds-0.9.3/`. Then specify it when you run `make`:
